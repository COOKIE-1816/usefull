...
#define IO_PIN_COUNT_TOTAL		32
#define IO_PIN_COUNT_DIGITAL	24
#define IO_PIN_COUNT_ANALOG		8
...
#define DIGITAL_WRITE_LOW(PIN)	( UNSET_BIT( GET_PORT(PIN), PIN) )
#define DIGITAL_WRITE_HIGH(PIN)	( SET_BIT(	 GET_PORT(PIN), PIN) )

#define DIGITAL_READ(PIN)		( GET_BIT (GET_PORT(PIN), PIN))

#define DIGITAL_WRITE(PIN, VAL)	( VAL ?							\
								( DIGITAL_WRITE_HIGH(PIN)) :	\
								( DIGITAL_WRITE_LOW( PIN))
